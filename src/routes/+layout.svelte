<script>
  ...
  console.log(
    ...
    "font-size: 20px; ;border-radius: 10px; border: 1px solid black; background: red; color: white; font"
  );
  console.log(
    "%c" + " Rohan Nikumbh ",
    "font-size: 40px; ;border-radius: 10px; border: 1px solid black; background: black; color: #4400ff"
  );
