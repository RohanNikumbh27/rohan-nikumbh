...
{#if pos == "left"}
  ...
  >
    <div
      ...
      class="relative inline-block p-7 my-6 pt-10 text-zinc-300 bg-gray-dark dark:shadow-md dark:shadow-black dark:hover:shadow-2xl dark:hover:shadow-white rounded-xl col-start-1 col-end-5 mr-auto md:mr-0 md:ml-auto transform transition duration-300 ease-in-out"
    >
      <!-- Tag at top right -->
      <Tag>{tag}</Tag>
    ...
    <div class="relative col-start-5 col-end-6 mr-7 md:mx-auto">
      ...
      <div class="flex items-center justify-center w-6 h-full">
        <div class="w-1 h-full bg-[#5d5d5d] rounded-t-full"></div>
      </div>
      <!-- circle round -->
      <div
...
{#if pos == "right"}
  ...
  >
    <div class="relative col-start-5 col-end-6 mr-7 md:mx-auto">
      <!-- line -->
      <div class="flex items-center justify-center w-6 h-full">
        <div class="w-1 h-full bg-[#5d5d5d]"></div>
      </div>
      <!-- cicle round -->
      <div
    ...
    <div
      use:perspectiveTilt={{ scale: 1.05 }}
      class="relative p-7 my-6 pt-10 text-zinc-300 bg-gray-dark dark:shadow-md dark:shadow-black dark:hover:shadow-2xl dark:hover:shadow-white rounded-xl col-start-6 col-end-10 mr-auto transition-all transform duration-300 ease-in-out"
    >
      <!-- Tag at top right -->
      <Tag>{tag}</Tag>
      <span class=" text-sm text-zinc-300 whitespace-nowrap">{date}</span>
