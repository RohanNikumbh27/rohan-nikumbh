...
<div class="container">
    <div class=" bg-zinc-200 rounded-2xl md:px-10  px-5 sm:px-5" id="contact">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-16 text-center">
        ...
        <p
          class="pt-6 pb-6 text-base max-w-2xl text-center m-auto text-zinc-900"
        >
      ...
      >
        <div>
          ...
          <p class="max-w-sm mt-4 mb-4 text-zinc-900">
        ...
        <div>
          <form method="POST" use:enhance|>
            ...
            <!-- <button
              type="submit"
              class="w-full py-4 font-bold text-xl text-white rounded-full  hover:bg-gray-800 focus:outline-none focus:ring-offset-2 focus:ring focus:ring-gray-200 px-7 bg-zinc-700"
              >Send Message
            </button> -->
            <Button title="Submit"/>
