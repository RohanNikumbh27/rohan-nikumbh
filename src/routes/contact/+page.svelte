...
<div class="container max-w-screen-2xl px-2 sm:px-4 md:px-6">
  <div class="bg-zinc-100 dark:bg-zinc-800 rounded-2xl md:px-10 px-2 sm:px-5" id="contact">
    ...
    <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 pt-8 pb-16 grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16">
      ...
      <div class="px-4">
        ...
        <div class="w-full overflow-x-auto pb-4">
          <div class="flex items-center mt-8 space-x-2 text-dark-600 text-zinc-900 max-w-full">
            <!-- Location Icon -->
          ...
          <div class="flex items-center mt-2 space-x-2 text-dark-600 text-zinc-900 max-w-full">
            <!-- Email Icon -->
            ...
            <a href="mailto:rohannikumbh2793@gmail.com" class="dark:text-zinc-400 break-all">rohannikumbh2793@gmail.com</a>
          </div>
          <div class="flex items-center mt-2 space-x-2 text-dark-600 text-zinc-900 max-w-full">
            <!-- Phone Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-4 dark:invert">
            ...
            <a href="tel:9284492299" class="dark:text-zinc-400 break-all">+91 9284492299</a>
          </div>
        </div>
      </div>
      <!-- Contact Form -->
