  ...
  async function handleFormSubmit(event) {
    ...
    if (isValid) {
      try {
        ...
        if (result.success) {
          showToast({
            message: "Message sent to Rohan Nikumbh",
            type: "success",
          });
...
<center>
  <h2 class="primary-heading pt-5 pb-1 dark:text-white mt-3 md:mt-7">
    Contact
  </h2>
</center>
...
<div class="container max-w-screen-2xl px-2 sm:px-4 md:px-6">
  <div
    class="bg-zinc-100 dark:bg-gray-dark rounded-2xl md:px-10 px-2 sm:px-5 border border-gray-dark/10 "
    id="contact"
  >
    ...
    <div
      class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8 pt-8 pb-16 grid grid-cols-1 md:grid-cols-2 gap-y-8 md:gap-x-8 md:gap-y-8 lg:gap-x-8 lg:gap-y-16"
    >
      <!-- Contact Info -->
      <div class="px-4">
        <h2 class="text-lg font-[500] text-zinc-900 dark:text-zinc-200">
          Contact Us
        </h2>
        ...
        <div class="w-full overflow-x-auto pb-4">
          <div
            class="flex items-center mt-8 space-x-2 text-dark-600 text-zinc-900 max-w-full"
          >
            <!-- Location Icon -->
            <svg
          ...
          <div
            class="flex items-center mt-2 space-x-2 text-dark-600 text-zinc-900 max-w-full"
          >
            <!-- Email Icon -->
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
              fill="currentColor"
              class="size-4 text-black dark:invert"
            >
              <path
            ...
            <a
              ...
              class="dark:text-zinc-400 break-all">rohannikumbh2793@gmail.com</a
            >
          </div>
          <div
            class="flex items-center mt-2 space-x-2 text-dark-600 text-zinc-900 max-w-full"
          >
            ...
            <a href="tel:9284492299" class="dark:text-zinc-400 break-all"
              >+91 9284492299</a
            >
          </div>
        </div>
      ...
      <!-- Contact Form -->
      <div>
        <div class="max-w-full flex items-center justify-center min-h-[370px]">
          {#if formStatus == "notSubmitted"}
            ...
            >
              {#if form?.missing}
                <div class="text-red-500 text-md mb-4 text-center">
                  {form?.message}
                </div>
              {/if}
              <div class="mb-5">
          ...
          {:else if formStatus == "loading"}
            ...
            >
              ...
              <p class="font-semibold text-primary-dark dark:text-zinc-400">
                Loading :)
              </p>
            </div>
            <!-- </div> -->
          {:else if formStatus == "submmited"}
            ...
            >
              <h1 class="text-primary-dark dark:text-white/70 text-[29px]">
                (<span class="text-primary">: </span>Thank you for your response
