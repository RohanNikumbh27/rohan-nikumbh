...
>
  ...
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/gmailIcon.svg" alt="" />
  </a>
  <!-- linkedin -->
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/linkedinIcon.svg" alt="" />
  </a>
  ...
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/whatsappIcon.svg" alt="Whatsapp Icon" />
  </a>
  ...
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/xIcon.svg" alt="Twitter Profile" />
  </a>
  ...
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/youtubeIcon.svg" alt="Youtube Channel" />
  </a>
  ...
  <a
    ...
    class="p-2 rounded-lg flex items-center justify-center transition-all duration-500 hover:border-transparent hover:border border border-transparent bg-gray-100 hover:bg-primary"
  >
    <img src="/socials/instaIcon.svg" alt="Instagram Profile" />
  </a>
</div>
