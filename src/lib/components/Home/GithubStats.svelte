...
<div class="flex items-center justify-center pt-10 md:pt-0 ">
  ...
  <section class="m-[15px]">
    <div  class="md:mb-10  bg-black/70 text-white px-6 py-8 max-w-sm sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-2xl mx-auto my-2 rounded-xl">
      <div class="space-y-4">
        <div class="flex gap-5 flex-col sm:flex-col md:flex-row justify-between">
          <div class="flex items-center w-full xl:px-5 "> 
            ...
            <span class="ml-auto font-semibold !text-primary ">{statsData.publicRepos}</span>
          </div>
  
          <div class="flex items-center w-full xl:px-5 ">
            <BookLock class="w-6 h-6 text-primary  mr-3" />
            <span>Private Repos count:</span>
            <span class="ml-auto font-semibold !text-primary ">{statsData.privateRepos}</span>
          </div>
        </div>
        ...
        <div class="flex gap-4 flex-col sm:flex-col md:flex-row justify-between">
          <div class="flex items-center w-full xl:px-5 ">
            ...
            <span>PR count:</span>
            <span class="ml-auto font-semibold !text-primary ">{statsData.prCount}</span>
          </div>
  
          <div class="flex items-center w-full xl:px-5 ">
            <GitCommitHorizontal class="w-6 h-6 text-primary  mr-3" />
            <span>Total contributions:</span>
            <span class="ml-auto font-semibold !text-primary ">{statsData.totalContributions}</span>
          </div>
        </div>
      </div>
    </div>
