...
<div class="fixed top-20 left-1/2 -translate-x-1/2 w-[90vw] max-w-[95vw] md:top-28 md:right-6 md:left-auto md:translate-x-0 md:w-[380px] z-[99] flex flex-col gap-3">
