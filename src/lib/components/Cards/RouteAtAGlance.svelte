...
<div class="relative m-4 p-6 rounded-2xl bg-white-100/70 dark:bg-neutral-900/70 border-[1px] dark:border-none transition-all duration-300 max-w-[500px] flex flex-col items-center text-center max-h-[370px] hover:border-primary/40">
    <!-- Decorative Bar -->
