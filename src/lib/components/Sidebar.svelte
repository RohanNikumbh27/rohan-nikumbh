...
{#if showNavbarSmall}
  ...
  <section id="MobileSidebar">
    ...
    >
     <div class="w-[50vw] h-[30vh] absolute dark:bg-zinc-500/30 bg-zinc-500/20 left-[25vw] blur-3xl z-[100000]"></div>
     <div class="w-[60vw] h-[30vh] absolute dark:bg-zinc-700/40 bg-zinc-500/30 left-[1vw] bottom-10 blur-3xl z-[100000]"></div>
     <div class="w-[60vw] h-[30vh] absolute dark:bg-gray-700/20 bg-zinc-500/20 -right-[10vw] bottom-[35vh] blur-3xl z-[100000]"></div>
