...
<div class="h-[40%] flex flex-col gap-12 lg:flex-row xl:gap-0">
  ...
  >
    ...
    >
      {#if showLoader}
        <Loader
          className="h-[500px] md:h-[450px] w-[330px] md:w-[350px] min-w-[340px] transition-all rounded-2xl md:mt-6"
        />
      {:else}
        <HeroImage />
      {/if}
  ...
  <!-- Text Content -->
  <div
    class="items-center flex h-full md:h-auto md:justify-center flex-col xl:justify-evenly rounded-2xl md:w-[85%] xl:w-[70%] md:mx-auto pr-0 lg:pr-0 2xl:pr-[74px] transition-c"
  >
    <div
    ...
    <p
      class="hero-subheading text-center text-xl leading-relaxed tracking-[0px] text-stone-500 dark:text-zinc-400 font-[350]"
    >
